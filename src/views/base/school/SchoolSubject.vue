<template>
    <div >
        ...
        <!-- 内容 -->
        <!-- 弹窗组件 Message ，Notice ，Modal ，-->
        <Button type="primary" @click="infoMessage">infoMessage 提示框</Button>
        <Button @click="open()">Notice </Button>
        <Button type="primary" @click="modal1 = true">Modal 弹框</Button>
        <Modal
            v-model="modal1"
            title="提供信息"
            ok-text="true"
...
export default {
    ...
    methods:{
        ...
        infoMessage(){//ivew-Message提示框
            // this.$Message.info('Message提示信息')
            // this.$Message.success('Message-success提示信息');
